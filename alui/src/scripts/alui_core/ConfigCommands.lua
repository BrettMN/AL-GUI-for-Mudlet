...
local function handleConfigCommand(action, category, key, value)
    ...
    if not action then
        ...
        cecho("<white>  config gui                  <dim_grey>- Open visual configuration panel\n")
        cecho("<white>  config test                 <dim_grey>- Run configuration integration tests\n")
        cecho("<white>  config demo                 <dim_grey>- Show configuration demo\n")
        cecho("<dim_grey>\nExamples:\n")
    ...
    elseif action == "gui" then
        if ALUI.ConfigGUI then
            ALUI.ConfigGUI.toggle()
        else
            cecho("<red>ConfigGUI not available.\n")
        end
    elseif action == "test" then
        if ALUI.ConfigTest then
            ALUI.ConfigTest.test()
        else
            cecho("<red>ConfigTest not available.\n")
        end
    elseif action == "demo" then
        if ALUI.ConfigTest then
            ALUI.ConfigTest.demo()
        else
            cecho("<red>ConfigTest not available.\n")
        end
    else
